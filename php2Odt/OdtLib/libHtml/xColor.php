 ...
 * @version 1.0
 */
abstract class xColor {

    static public function color_name_to_hex($color_name) {
        // standard 147 noms de couleur
        $colors = array(
            'aliceblue' => 'F0F8FF',
            'antiquewhite' => 'FAEBD7',
            'aqua' => '00FFFF',
        ...
        if (isset($colors[$color_name])) {
            return ('#' . strtolower($colors[$color_name]));
        } else {
            return ($colors['black']);
        }
    }
    ...
    static public function rgb2hex($rgb) {
        ...
        return $hex; // retourne la valeur hexadecimal suivi d'un (#)
    }
